...
export const LoadingSpinner: React.FC<{ message?: string }> = ({ message = "Analyzing Call Audio..." }) => {
  return (
    <div className="flex flex-col justify-center items-center py-8" aria-live="polite" aria-busy="true">
      ...
      <p className="ml-0 mt-3 text-md text-slate-300 tracking-wide font-orbitron">
        {message}
      </p>
    </div>
  );
